...
$sourceRoot = Join-Path -Path "$sourceDirectory" -ChildPath 'v3'
...
$manifest = @{
    ...
    ModuleVersion     = "3.0.0"
    HelpInfoUri       = "$projectUriRoot/tree/main/docs/v3"
    LicenseUri        = "$projectUriRoot/blob/main/LICENSE"
    ProjectUri        = "$projectUriRoot"
    Description       = 'Module to be used with Easit BPS & Easit GO webservice API'
    PowerShellVersion = '7.0'
    Copyright         = "(c) 2022 Easit AB. All rights reserved."
}
